...
################################################################################
    ...
    def schedule(self):
        ...
        if self.checkBox_min.isChecked():
            ...
            self.label_info.setText(f"Toolbox will shutdown in {value} minutes!")
            ...
            self.label_info.setText(f"Toolbox will shutdown in {value} hours!")
            self.set_up_button.setEnabled(False)
            ...
            if final_num <= 0:
                ...
                self.set_up_button.setEnabled(False)
                if m < 10:
                    self.label_info.setText(f"Toolbox will shutdown at {h}:0{m} !")
                    self.tray.setToolTip(f"Toolbox will shutdown at {h}:0{m} !")
                else:
                    self.label_info.setText(f"Toolbox will shutdown at {h}:{m} !")
                    self.tray.setToolTip(f"Toolbox will shutdown at {h}:{m} !")
        ...
        if self.checkBox_min.isChecked():
            ...
            if action_time.day == now.day:
                self.tray.setToolTip(
                    f"Toolbox will shutdown at {action_time.hour}:{action_time.minute} !")
            else:
                self.tray.setToolTip(
                    f"Toolbox will shutdown on {action_time.day}/{action_time.month}/{action_time.year} at {action_time.hour}:{action_time.minute} !")
